...
public class CommentQueryServletforRestByRest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("restcommentPageByRest", restcommentPage);
		
		request.getRequestDispatcher("restcomment_query_rest.jsp").forward(request, response);
	}
