...
public class OrderQueryBySuperServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		OrderPage orderPage = orderdetailService.findFinishedOrderByRest(currentPage, pageSize, restid);
		
		request.setAttribute("orderPage", orderPage);

		request.getRequestDispatcher("restorder_query_super.jsp").forward(request, response);
	}
